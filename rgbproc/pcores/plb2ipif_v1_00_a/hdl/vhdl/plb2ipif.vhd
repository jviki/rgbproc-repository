------------------------------------------------------------------------------
-- plb2ipif.vhd - entity/architecture pair
------------------------------------------------------------------------------
-- IMPORTANT:
...
library plb2ipif_v1_00_a;
use plb2ipif_v1_00_a.user_logic;
...
entity plb2ipif is
  ...
  (
	...
	Bus2IP_Addr                    : out std_logic_vector(C_SPLB_AWIDTH-1 downto 0);
	Bus2IP_CS                      : out std_logic_vector(0 downto 0);
	Bus2IP_RNW                     : out std_logic;
	Bus2IP_Data                    : out std_logic_vector(C_SPLB_NATIVE_DWIDTH-1 downto 0);
	Bus2IP_BE                      : out std_logic_vector(C_SPLB_NATIVE_DWIDTH/8-1 downto 0);
...
architecture IMP of plb2ipif is
...
begin
  ...
  ------------------------------------------
  USER_LOGIC_I : entity plb2ipif_v1_00_a.user_logic
    generic map
    (
	...
	S_Bus2IP_Clk                => Bus2IP_Clk,
	S_Bus2IP_Reset              => Bus2IP_Reset,
